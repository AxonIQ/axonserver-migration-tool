<!--
Thanks for taking the time to draft up an issue for Axon Server Migration Tool!
Prior to starting off, please read the following:

## Usage Questions

If you are having difficulty using Axon Server Migration Tool, take the following into account:
...
You can find all three of them [here](https://github.com/AxonIQ/axonserver-migration-tool/issues/new/choose). 
